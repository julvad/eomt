...
class torchDiceLoss(nn.Module): # for binary segmentation TODO: FINISH THIS
    def __init__(self, smooth=1.0, mode:Literal['micro','macro']='macro'):
        super().__init__()
...
def compute_class_weights(dataloader, num_classes): # for weighted class loss
    ...
    weights = weights / weights.sum() * num_classes  # normalize weights 0-1
    return weights
...
#########################################
"""Focal loss from https://github.com/DannyCollinson/pytorch-focalloss/blob/main/src/torch_focalloss/losses.py"""
